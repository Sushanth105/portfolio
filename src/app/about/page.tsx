      ...
      <div className="grid md:grid-cols-3 gap-8 items-start">
        <Card className="md:col-span-2 shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent className="space-y-6 text-base leading-relaxed text-foreground/90">
            <p>
              Hello! I'm Sushanth, a BE Computer Science Student with a strong foundation in web technologies and a keen eye for user experience. My journey into the world of tech began with a fascination for how software could solve real-world problems and connect people in meaningful ways.
            </p>
            <p>
        ...
        <div className="space-y-8 md:col-span-1">
           <Card className="shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader>
                ...
                <Image src="/profile.png" alt="Sushanth's Portrait" width={100} height={100} className="rounded-full mr-4 border-2 border-primary p-1" />
                 <span>Sushanth</span>
                </CardTitle>
